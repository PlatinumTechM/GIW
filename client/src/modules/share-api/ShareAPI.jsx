  ...
  const fetchMyApiKeys = async () => {
    try {
      const response = await api.get(
        `/share-api/my?page=${currentPage}&limit=${itemsPerPage}`,
      );
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-4 sm:px-8 py-6 sm:py-8">
          <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left text-white">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-xs sm:text-sm mt-1 font-medium opacity-90">
                Generate secure authorized tokens for external stock sharing
              </p>
            </div>
          </div>
        </div>
            ...
            {showAdvanced && (
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 pt-2">
                  <div className="space-y-2">
                    <label className="text-xs font-semibold text-gray-700 px-1 flex items-center gap-2">
                      <Filter className="w-4 h-4 text-indigo-500" /> Include
                    </label>
                    <input
                      type="text"
                      ...
                      onChange={handleInputChange}
                      placeholder="Include Categories (e.g. Round, Princess)"
                      className="w-full input-field"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-semibold text-gray-700 px-1 flex items-center gap-2">
                      <Filter className="w-4 h-4 text-red-500" /> Exclude
                    </label>
                    <input
                      type="text"
                      ...
                      onChange={handleInputChange}
                      placeholder="Exclude Categories (e.g. Emerald, Sapphire)"
                      className="w-full input-field"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <label className="text-xs font-semibold text-gray-700 px-1 flex items-center gap-2">
                    <Shield className="w-4 h-4 text-indigo-500" /> Grant
                    Permissions
                  </label>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        ...
                        title={
                          key.is_active ? "Deactivate Token" : "Activate Token"
                        }
                      >
                        {key.is_active ? (
            ...
            <div className="px-6 py-6 border-t border-gray-50 flex flex-col items-center gap-4 bg-gray-50/30">
              ...
              <div className="flex items-center gap-4 text-xs font-medium">
                <p className="text-gray-500">
                  ...
                  of <span className="text-indigo-600">{totalCount}</span>{" "}
                  tokens
                </p>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="p-4 bg-white rounded-xl border border-gray-200 space-y-3 shadow-sm">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="px-2 py-0.5 bg-indigo-50 text-indigo-600 text-[10px] font-bold rounded border border-indigo-100 uppercase">
                            Bearer Token
                          </span>
                        </div>
