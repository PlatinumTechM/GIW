// 8. Minimalist Glassmorphism (Clarity Focus)
...
const Home = () => {
  ...
  return (
    <motion.div
      ref={containerRef}
      className="min-h-screen overflow-x-hidden bg-gradient-to-br from-[#F0F9FF] to-[#E0F2FE] text-[#0F172A]"
    >
      {/* Hero Section */}
      <motion.section
        ref={heroRef}
      ...
      >
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#0EA5E9]/10 via-[#E0F2FE] to-[#0EA5E9]/5" />
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-14 px-4 py-28 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/40 bg-white/20 px-4 py-2 text-sm font-medium text-[#0F172A] backdrop-blur-xl shadow-lg"
            >
            ...
            <motion.p
              variants={fadeInUp}
              className="mb-8 max-w-2xl text-base leading-relaxed text-[#334155] sm:text-lg"
            >
            ...
            >
              ...
              <Link
                to="/login"
                className="inline-flex items-center gap-2 rounded-xl border border-white/40 bg-white/30 px-8 py-4 font-semibold text-[#0F172A] backdrop-blur-lg transition-all duration-300 hover:border-[#0EA5E9]/50 hover:bg-white/50"
              >
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="rounded-2xl border border-white/40 bg-white/25 p-6 shadow-[0_8px_32px_rgba(14,165,233,0.15)] backdrop-blur-xl transition-all duration-300 hover:border-[#0EA5E9]/40 hover:shadow-[0_12px_40px_rgba(14,165,233,0.25)]"
              >
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            <motion.div variants={fadeInUp}>
              <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/40 bg-white/20 px-4 py-1.5 text-sm font-medium text-[#0F172A] backdrop-blur-lg shadow-sm">
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                variants={fadeInUp}
                whileHover={{ y: -10 }}
                className="group relative overflow-hidden rounded-2xl border border-white/40 bg-white/30 p-8 shadow-[0_8px_32px_rgba(14,165,233,0.1)] backdrop-blur-lg transition-all duration-300 hover:border-[#0EA5E9]/40 hover:shadow-[0_15px_40px_rgba(14,165,233,0.2)]"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/0 via-white/0 to-[#0EA5E9]/5 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
      ...
      <section className="bg-transparent px-4 py-24">
        <div className="mx-auto max-w-7xl">
          ...
          >
            <div className="absolute left-1/4 right-1/4 top-24 hidden h-px bg-gradient-to-r from-transparent via-[#0EA5E9]/30 to-transparent md:block" />
            ...
            {steps.map((item, index) => (
              ...
              >
                <div className="absolute -top-3 left-0 text-7xl font-bold text-[#0EA5E9]/10 transition-colors duration-300 group-hover:text-[#0EA5E9]/20">
                  {item.step}
                </div>
      ...
      {/* Security */}
      <section className="overflow-hidden bg-white/20 backdrop-blur-lg px-4 py-24 border-y border-white/40">
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          ...
          >
            <motion.span
              variants={fadeIn}
              className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/40 bg-[#0EA5E9]/10 px-4 py-1.5 text-sm font-medium text-[#0EA5E9] backdrop-blur-lg"
            >
            ...
            >
              {securityFeatures.map((security, index) => (
                <motion.div
                  ...
                  className="flex items-center gap-3 rounded-xl border border-white/40 bg-white/40 p-4 shadow-[0_4px_20px_rgba(14,165,233,0.1)] backdrop-blur-lg transition-all duration-300 hover:border-[#0EA5E9]/30"
                >
      ...
      <section className="bg-transparent px-4 py-24">
        <div className="mx-auto max-w-5xl">
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
            className="relative overflow-hidden rounded-3xl border border-white/40 bg-white/30 p-10 text-center shadow-[0_20px_60px_rgba(14,165,233,0.15)] backdrop-blur-xl md:p-16"
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <a
                  href="#"
                  className="rounded-xl border border-white/40 bg-white/40 px-8 py-4 font-semibold text-[#0F172A] backdrop-blur-lg transition-all duration-300 hover:border-[#0EA5E9]/50 hover:bg-white/60"
                >
                  Learn More
                </a>
              </div>
