...
const UserManagement = () => {
  ...
  const SortIcon = ({ columnKey }) => {
    if (sortConfig.key !== columnKey) {
      return <svg className="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" /></svg>;
    }
    return sortConfig.direction === 'asc' ?
      <svg className="w-3 h-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 15l7-7 7 7" /></svg> :
      <svg className="w-3 h-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>;
  };
  ...
  const verifyAndShowPassword = async () => {
    try {
      ...
      if (response.success) {
        ...
        notify.error("Access Denied", response.message || "Incorrect admin password");
      }
    } catch (error) {
      console.error("Password verification error:", error);
      const errorMessage = error.response?.data?.message || error.message || "Incorrect admin password";
          ...
          <table className="w-full">
            <thead className="bg-gradient-to-r from-slate-50 to-slate-100 sticky top-0 z-10">
              <tr>
                ...
                <th
                  className="px-4 py-4 text-left text-xs font-bold text-slate-700 uppercase tracking-wider sticky top-0"
                >
                  <div className="flex items-center gap-2">
                ...
                <th
                  className="px-4 py-4 text-center text-xs font-bold text-slate-700 uppercase tracking-wider sticky top-0"
                >
                  <div className="flex items-center justify-center gap-2">
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-center">
                      {revealedPassword === user.id ? (
                        <div className="flex items-center justify-center gap-2">
                          <code className="px-2 py-1 bg-amber-100 text-amber-800 rounded text-xs font-mono">{user.password || 'N/A'}</code>
                          <motion.button
              ...
              <div className="px-6 pb-6">
                ...
                >
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    ...
                    <p className="font-semibold text-gray-900">{selectedUser.company || "N/A"}</p>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <p className="text-xs font-medium text-gray-500 uppercase">GST Number</p>
                    </div>
                    <p className="font-semibold text-gray-900">{selectedUser.gst || "N/A"}</p>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    ...
                    <p className="font-semibold text-gray-900">{selectedUser.joined}</p>
                  </div>
                  ...
                  <div className="col-span-2 bg-gray-50 rounded-xl p-4 border border-gray-100">
                    ...
                    <p className="font-semibold text-gray-900">{selectedUser.address || "N/A"}</p>
                  </div>
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Enter your admin password to view user password</p>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onKeyDown={(e) => e.key === 'Enter' && verifyAndShowPassword()}
