        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-slate-100 via-slate-200 to-slate-300 rounded-xl flex items-center justify-center shadow-lg">
                <svg
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  ...
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-slate-600 group-hover:bg-slate-300 transition-colors" />
                    {link.label}
                  </Link>
                </li>
              ))}
