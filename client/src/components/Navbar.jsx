...
import LiveRates from "./common/LiveRates";
...
const Navbar = () => {
  ...
  return (
    <nav
      className={`relative left-0 right-0 z-[1000] transition-all duration-300 border-b border-gray-100/50 py-3 ${
        isScrolled
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group relative">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-black tracking-tighter text-[#0F172A] leading-none">
                GIW
              </span>
              <span className="text-[10px] font-bold text-[#2e7c9e] uppercase tracking-[0.2em] mt-0.5">
                Diamond Exchange
              </span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-4">
            {isAuthenticated ? (
              <div className="flex items-center gap-3">
                ...
                >
                  <button className="flex items-center gap-3 p-1 pr-3 rounded-2xl bg-white border border-gray-100 hover:border-[#2e7c9e]/30 transition-all group">
                    ...
                    <ChevronDown
                      className={`w-4 h-4 text-[#475569] transition-transform duration-300 ${isUserDropdownOpen ? "rotate-180" : ""}`}
                    />
                  </button>
                    ...
                    {isUserDropdownOpen && (
                      ...
                      >
                        <div className="px-5 py-5 bg-gradient-to-br from-[#d9f0fa]/50 to-white border-b border-gray-50">
                          <p className="text-[10px] font-bold text-[#2e7c9e] uppercase tracking-widest mb-1">
                        ...
                        <div className="p-2 space-y-1">
                          ...
                          <button
                            ...
                            className="flex items-center gap-3 px-4 py-3 w-full text-sm font-semibold text-red-600 hover:bg-red-50 rounded-xl transition-all group"
                          >
              ...
              <div className="hidden lg:flex items-center gap-4">
                <Link
                  to="/login"
                  className="px-5 py-2.5 text-sm font-bold text-[#475569] hover:text-[#2e7c9e] transition-colors"
                >
                  Sign In
                </Link>
                ...
                >
                  <button className="btn-primary px-6 py-2.5 text-sm flex items-center gap-2">
                    ...
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-300 ${isJoinDropdownOpen ? "rotate-180" : ""}`}
                    />
                  </button>
                      ...
                      >
                        <div className="p-2 space-y-1">
                          <Link
                            ...
                            className="flex items-center gap-3 px-4 py-4 text-sm font-semibold text-[#475569] hover:text-[#2e7c9e] hover:bg-[#d9f0fa]/30 rounded-xl transition-all group"
                          >
            ...
            <div className="px-4 py-6 space-y-2">
              ...
              {!isAuthenticated && (
                <div className="pt-4 grid grid-cols-2 gap-3">
                  <Link
                    to="/login"
                    className="flex items-center justify-center px-4 py-4 rounded-2xl text-sm font-bold text-[#475569] bg-gray-50"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    Login
                  </Link>
                  <Link
                    to="/register"
                    className="flex items-center justify-center px-4 py-4 rounded-2xl text-sm font-bold text-white bg-[#2e7c9e]"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    Join GIW
                  </Link>
