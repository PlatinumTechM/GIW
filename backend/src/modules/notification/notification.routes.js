...
router.post("/", authenticate, validateCreateNotification, notificationController.createNotification);
...
router.put("/:id", authenticate, validateUpdateNotification, notificationController.updateNotification);
